...
// Source: github.com/eclipse/paho.mqtt.golang (interfaces: Client,Token)
...
func (m *MockClient) AddRoute(arg0 string, arg1 paho_mqtt_golang.MessageHandler) {
	m.ctrl.T.Helper()
...
func (m *MockClient) Connect() paho_mqtt_golang.Token {
	m.ctrl.T.Helper()
...
func (m *MockClient) OptionsReader() paho_mqtt_golang.ClientOptionsReader {
	m.ctrl.T.Helper()
...
func (m *MockClient) Publish(arg0 string, arg1 byte, arg2 bool, arg3 interface{}) paho_mqtt_golang.Token {
	m.ctrl.T.Helper()
...
func (m *MockClient) Subscribe(arg0 string, arg1 byte, arg2 paho_mqtt_golang.MessageHandler) paho_mqtt_golang.Token {
	m.ctrl.T.Helper()
...
func (m *MockClient) SubscribeMultiple(arg0 map[string]byte, arg1 paho_mqtt_golang.MessageHandler) paho_mqtt_golang.Token {
	m.ctrl.T.Helper()
...
func (m *MockClient) Unsubscribe(arg0 ...string) paho_mqtt_golang.Token {
	m.ctrl.T.Helper()
	varargs := []interface{}{}
	for _, a := range arg0 {
